...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--use_masked_training', action='store_true', help='Use masked training to mask out empty regions in the images')
        parser.add_argument('--mask_in_data', action='store_true', help='Use mask in the data')
