...
def projectVeloToImage(cam_id=0, seq=0, visualize=False, frames_to_project=[0]):
    ...
    for frame in frames_to_project:
        ...
        binary_frame[v[mask],u[mask]] = intensity[mask]*255

        projected_frames.append(binary_frame)
