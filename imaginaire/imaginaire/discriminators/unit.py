    ...
    def __init__(self, dis_cfg, data_cfg):
        ...
        if getattr(dis_cfg, 'patch_dis', True):
            ...
            self.discriminator_b = \
                WeightSharedMultiResPatchDiscriminator(**vars(dis_cfg), image_channels = 1, num_image_channels= 1)
        else:
            ...
            self.discriminator_b = ResDiscriminator(**vars(dis_cfg), image_channels = 1)
