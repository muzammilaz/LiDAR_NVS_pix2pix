...
class Trainer(BaseTrainer):
    ...
    def _get_visualizations(self, data):
        ...
        with torch.no_grad():
            ...
            # expand single channel into 3 channels
            vis_images = [data['images_a'],
                          data['images_b'].expand(-1, 3, -1, -1),
                          net_G_output['images_aa'],
                          net_G_output['images_bb'].expand(-1, 3, -1, -1),
                          net_G_output['images_ab'].expand(-1, 3, -1, -1),
                          net_G_output['images_ba'],
                          net_G_output['images_aba'],
                          net_G_output['images_bab'].expand(-1, 3, -1, -1)]
            return vis_images
